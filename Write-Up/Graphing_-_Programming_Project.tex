...
\end{algorithm}
\newpage
Another important part of the parsing stage is to standardize the input. This is where we convert any inconsistencies discussed in section \ref{funcClass}  (\pageref{funcClass}).
\newpage
