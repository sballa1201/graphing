...
public interface ChangeScene {
	...
	public default void translate(ActionEvent event, String name, int seconds)
			throws IOException, InterruptedException {
		Pane pane = FXMLLoader.load(getClass().getResource("/" + name + ".fxml"));
		Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();

		TranslateTransition transOut = new TranslateTransition(Duration.seconds(seconds),
				(Pane) ((Node) event.getSource()).getParent());
