...
\begin{table}[ht] \caption{Single- vs Multi-Threaded Approach Test} % title of Table
...
\hline
\multicolumn{1}{|c|}{\multirow{3}{*}{\parbox{1.65cm}{Number of Operators}}} & \multicolumn{8}{c|}{Time Taken/ms}                                                                                                                                                                          \\ \cline{2-9} 
