...
\begin{tabular}{| l | S[table-format=4.2] | S[table-format=4.2] | S[table-format=4.2] | S[table-format=4.2,separate-uncertainty,table-figures-uncertainty=1] | S[table-format=4.2] | S[table-format=4.2] | S[table-format=4.2] | S[table-format=4.2,separate-uncertainty,table-figures-uncertainty=1] | S[table-format=4.2] | S[table-format=4.2] | S[table-format=4.2] | S[table-format=4.2,separate-uncertainty,table-figures-uncertainty=1] | S[table-format=4.2,separate-uncertainty,table-figures-uncertainty=1] |}
\hline
...
\\ \hline
100 	& 2.03 & 2.14 & 2.25 & 2.14 \pm 0.11 &		 3.26 & 2.77 & 2.97 & 3.00 \pm 0.25 &			 5.69 & 5.34 & 5.15 & 1.0	 & 1.0
\\ \hline
1000 	& 5.87 & 4.11 & 5.66 & 1.0 &		 47.30 & 42.29 & 39.9 & 1.0 &			 15.22 & 18.61 & 32.20 & 1.0	 & 1.0
\\ \hline
\end{tabular}
